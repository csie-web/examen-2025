...
import TaskStatusStore from '../../state/stores/TaskStatusStore'
...
const App = () => {
  ...
  const [taskStatusStore] = useState(new TaskStatusStore())
    ...
    >
      ...
      <Router>
        <Routes>
          ...
          />
          <Route
            path='/task-statuses/new' element={
              <AuthGuard isAuthenticated={isAuthenticated}>
                <TaskStatusForm />
              </AuthGuard>
          }
