...
apiRouter.get('/users/:uid/projects/:pid/tasks/:tid/comments/:cid', controllers.comment.getOneCommentForTask)
apiRouter.post('/users/:uid/projects/:pid/tasks/:tid/comments', controllers.comment.createOwnedCommentForTask)
apiRouter.put('/users/:uid/projects/:pid/tasks/:tid/comments/:cid', middleware.getPermMiddleware('cid', ['write']), controllers.comment.updateOwnedCommentForTask)
apiRouter.delete('/users/:uid/projects/:pid/tasks/:tid/comments/:cid', middleware.getPermMiddleware('cid', ['write']), controllers.comment.deleteOwnedCommentForTask)
